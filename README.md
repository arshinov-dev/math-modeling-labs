...
| 5 | Численные методы решения уравнений | ✅ Готово | [lab-05](./lab-05-equation-solving-methods/) |
...
│   ├── examples/                 # Примеры графиков
│   └── plots/                    # Авто-генерация png/svg
└── lab-05-equation-solving-methods/ # Лабораторная работа №5
    ├── README.md                 # Общая инструкция по л/р
    ├── run_all.py                # Последовательный запуск всех методов
    ├── bisection-newton/         # Бисекция и метод касательных
